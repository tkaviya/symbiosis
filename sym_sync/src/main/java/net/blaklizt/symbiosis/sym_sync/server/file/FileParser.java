...
//
//    protected static final Logger logger = Configuration.getNewLogger(SymSyncDataQueue.class.getSimpleName());
//
//
...
//
//                Message message = SymSyncDataQueue.apacheMQueSession.createMapMessage();
//                message.setStringProperty(hexStr, objectStr);
//
//                SymSyncDataQueue.syncQueue.send(message);
//            }
//            catch (Exception ex)
//            {
