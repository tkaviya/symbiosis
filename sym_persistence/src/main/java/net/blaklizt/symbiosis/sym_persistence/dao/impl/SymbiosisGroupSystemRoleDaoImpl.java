...
import net.blaklizt.symbiosis.sym_persistence.dao.SymbiosisGroupSystemRoleDao;
...
@Repository
public class SymbiosisGroupSystemRoleDaoImpl extends
		AbstractDao<symbiosis_group_system_role, Long> implements SymbiosisGroupSystemRoleDao
{
