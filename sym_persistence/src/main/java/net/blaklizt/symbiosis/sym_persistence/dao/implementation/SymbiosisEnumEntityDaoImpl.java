...
//
//
//public abstract class SymbiosisEnumEntityDaoImpl<E extends symbiosis_entity, I extends Serializable>
//        extends AbstractDao<E, I> implements SymbiosisEnumEntityDao<E, I> {
//
...
//        return (List<symbiosis_option>)findByCriteria(Restrictions.eq("enabled", true));
//    }
//
//    @Override
