...
//    private static HashMap<Class<? extends symbiosis_enum_entity>, SymbiosisEnumHelper> registeredHelpers = new HashMap<>();
    ...
    private static SymbiosisEnumHelper symbiosisDBEnumHelper = new SymbiosisEnumHelper();

    //cache for all enum values
    private static final HashMap<String, HashMap<String, Long>> valueMap = new HashMap<>();

    //populate cache
    public static SymbiosisEnumHelper getDaoHelper(SymbiosisEnumEntityDao entityDao) {
        populateCache(entityDao);
        return symbiosisDBEnumHelper;
    }

    private SymbiosisEnumHelper() {}
